...
public enum ErrorCode {
	...
	ENTITY_NOT_FOUND(404, "C004", "요청한 자원이 서버에 존재하지 않습니다."),
	
	// Survey
	INVALID_SURVEY_OWNER(403, "S001", "다른 사용자의 설문조사를 수정할 수 없습니다."),
	INVALID_SURVEY_STATUS(403, "S002", "배포가 시작된 설문조사를 수정할 수 없습니다."),
	INVALID_SURVEY_VISIBILITY(403, "S003", "공개되어 있지 않은 설문조사입니다."),
	DELETED_SURVEY(403, "S004", "삭제된 설문조사입니다."),
